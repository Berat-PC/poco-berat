...
let inputBirthyear = Number(prompt("Please type your birthday : "));
let inputFutureYear = Number(prompt("Please type a year from future : "));
let age1= Number(inputFutureYear-inputBirthyear);
let age2 = Number(inputFutureYear-inputBirthyear-1);

alert("You will be "+ age1 + " or " + age2 + " years old in " + inputFutureYear);